...
export default function ChatGreetings() {
  return (
    <div className="text-left mb-8 w-full tracking-tighter leading-snug">
      ...
      <h2 className="text-5xl font-semibold text-muted-foreground">What would like to know?</h2>
      <p className="text-muted-foreground mt-4 text-lg max-w-sm leading-tight text-balance">
